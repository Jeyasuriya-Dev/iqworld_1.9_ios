...
export class SidebarComponent implements OnInit {
	...
	Complaint_count: any;
	adminDetails: any;
	currentDateTime: any = sessionStorage.getItem('currentDateTime');
	currentVersion = clienturl.CURRENT_VERSION();

	public showNavbarBackBtn: boolean = false; // Declare a var for backButton


	constructor(private observer: BreakpointObserver, private token: StorageService, private deviceinfoComponent: DeviceinfoComponent, private clientListComponent: ClientListComponent, private authService: AuthService, private router: Router, private clientService: ClientService, private matDialog: MatDialog,
	...
	ngOnInit(): void {
		...
		this.adminDetails = this.token.getUser()
	...
	getComplaintList() {
		// getComplaintCountByDistributorOrAdmin
		this.clientService.getComplaintCountByDistributorOrAdmin('admin').subscribe((res: any) => {
		...
		// this.clientService.getComplaintListbyView().subscribe((res: any) => {
		//   this.notificatons = res;
		//   // console.log(res);
	...
	goToDevicePage(id: any, unq: any) {
		// console.log(id + " " + unq);
		this.router.navigateByUrl("admin/" + id).then(e => {
