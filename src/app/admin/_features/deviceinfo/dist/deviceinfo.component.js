...
exports.DeviceinfoComponent = exports.Client = void 0;
...
var DeviceinfoComponent = /** @class */ (function () {
    function DeviceinfoComponent(clientService, exportService, renderer, observer, matDialog, excelService, pdfService, tokenStorage) {
        var _this = this;
        ...
        this.todate = "null";
        // filter==============
        this.selectDistributor = { id: 0 };
        this.selectedClient = { id: 0, username: 0 };
        ...
        this.orientationList = [{ id: "9:16", name: 'Vertical' }, { id: "16:9", name: 'Horizontal' }];
        this.filteredOrientationList = this.orientationList.slice();
        this.activeList = [{ id: 1, name: 'active', value: true }, { id: 0, name: 'inactive', value: false }];
    ...
    DeviceinfoComponent.prototype.ispinned = function (s) {
        if (s) {
            return null;
        }
        else {
    ...
    DeviceinfoComponent.prototype.ngOnInit = function () {
        ...
        this.clientService.getStateListWithoutAll().subscribe(function (res) {
            console.log(res);
            _this.stateList = res;
            _this.filteredStateList = res;
        });
        console.log(this.tokenStorage.getUserRole());
        console.log((_a = this.tokenStorage.getDistributor()) === null || _a === void 0 ? void 0 : _a.roles);
    ...
    DeviceinfoComponent.prototype.getAllDeviceModel = function () {
        var _this = this;
    ...
    DeviceinfoComponent.prototype.getAllClientList = function () {
        var _this = this;
        if (this.isDistributor) {
            ...
            if (user.roles[0] == "ROLE_DISTRIBUTOR") {
                this.clientService.getdistributorByUsername(user.username).subscribe(function (res) {
                    // console.log(res);
                    _this.selectDistributor = res;
                    _this.getAllClientByDistributor(_this.selectDistributor);
    ...
    DeviceinfoComponent.prototype.onChooseClient = function (clientname) {
        var _this = this;
        this.selectClient = clientname;
        this.clientService.getdeviceListbyclientusername(clientname).subscribe(function (res) {
            console.log(res);
            _this.rowData = res;
        });
    };
    DeviceinfoComponent.prototype.CellRendererBtn = function (params) {
        var _this = this;
        var _a;
    ...
    DeviceinfoComponent.prototype.logOutDevice = function (data) {
        var _this = this;
    ...
    DeviceinfoComponent.prototype.onGridReady = function (params) {
        this.gridApi = params.api;
        // this.getAllDeviceList();
        // this.getAllDeviceModel();
    };
    DeviceinfoComponent.prototype.updateDeviceModelname = function (deviceno, modelname) {
        var _this = this;
        sweetalert2_1["default"].fire({
            title: "Are you sure?",
    ...
    DeviceinfoComponent.prototype.getAllDeviceList = function () {
        var _this = this;
        if (this.isDistributor) {
            var user = this.tokenStorage.getUser();
            if (user.roles[0] == "ROLE_DISTRIBUTOR") {
                this.clientService.getdistributorByUsername(user.username).subscribe(function (res) {
                    // console.log(res);
                    _this.clientService.getTotalDevicesByDistributorId(res.id).subscribe(function (res) {
                        // console.log(res);
                        _this.rowData = res;
            ...
            this.clientService.getAllDevicesList().subscribe(function (res) {
                // console.log(res);
                _this.rowData = res;
    ...
    DeviceinfoComponent.prototype.onQuickFilterChanged = function () {
        // console.log(this.gridApi);
        this.gridApi.setQuickFilter(document.getElementById('quickFilter').value);
    };
    DeviceinfoComponent.prototype.filterClients = function (username) {
    ...
    DeviceinfoComponent.prototype.clearCountryCtrl = function () {
        this.countryCtrl.setValue("");
        this.getAllDeviceList();
    };
    DeviceinfoComponent.prototype.exportAsExcelFile = function () {
        var title = capitalize(this.selectClient) + ' Device Details';
        var data = [];
    ...
    DeviceinfoComponent.prototype.exportPdf1 = function () {
    ...
    DeviceinfoComponent.prototype.exportPdf = function () {
    ...
    DeviceinfoComponent.prototype.getDistibutorList = function () {
        var _this = this;
    ...
    DeviceinfoComponent.prototype.getAllClientByDistributor = function (event) {
        var _this = this;
        console.log(event);
    ...
    DeviceinfoComponent.prototype.getStatelistByClient = function (client) {
        var _this = this;
    ...
    DeviceinfoComponent.prototype.getDistrictbyStatelist = function (state) {
        var _this = this;
        var _a;
    ...
    DeviceinfoComponent.prototype.getCitybyDistrictList = function (district) {
        var _this = this;
        var _a;
    ...
    DeviceinfoComponent.prototype.getLocationByStateAndCity = function (city) {
        var _this = this;
        var _a;
    ...
    DeviceinfoComponent.prototype.getCustomerVersion = function () {
        var _this = this;
    ...
    DeviceinfoComponent.prototype.getFromDate = function (event) {
    ...
    DeviceinfoComponent.prototype.getToDate = function (event) {
        var date = new Date(event.value).getDate();
        var month = new Date(event.value).getMonth() + 1;
        var year = new Date(event.value).getFullYear();
    ...
    DeviceinfoComponent.prototype.getLocation = function (location) {
        this.selectedLocation = location;
        this.filterDeviceList();
    };
    DeviceinfoComponent.prototype.getOrientation = function (location) {
        this.selectedOrientation = location;
        this.filterDeviceList();
    };
    DeviceinfoComponent.prototype.getActive = function (location) {
        this.selectedActive = location;
        this.filterDeviceList();
    };
    DeviceinfoComponent.prototype.getVersion = function (location) {
        this.selectedVersion = location;
        this.filterDeviceList();
    };
    DeviceinfoComponent.prototype.getOnline = function (e) {
        this.selectedIsonline = e;
        this.filterDeviceList();
    };
    DeviceinfoComponent.prototype.filterDeviceList = function () {
        var _this = this;
