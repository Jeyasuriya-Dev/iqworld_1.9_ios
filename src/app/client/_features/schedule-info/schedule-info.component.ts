...
export class ScheduleInfoComponent {
  ...
  constructor(private storageService: StorageService, private alertService: AlertService, private router: Router, private matDialog: MatDialog, private clientService: ClientService) {
  ...
  columnDefs: ColDef[] = [
    ...
    },
    {
      headerName: 'Actions', cellRenderer: (params: any) => {
        ...
        editButton.addEventListener('click', () => {
          this.router.navigateByUrl("client/verify-playlist/" + rowData.playlistid);
        });
    ...
    ,
    { headerName: 'Remark', field: 'comments', },
